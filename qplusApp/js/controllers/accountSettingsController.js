angular.module('MUHCApp')
    ...
    .controller('accountSettingController', ['UserDataMutable', 'UserPreferences','$scope','$timeout','UpdateUI', function (UserDataMutable, UserPreferences, $scope, $timeout,UpdateUI) {
