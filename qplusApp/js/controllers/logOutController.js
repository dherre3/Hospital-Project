...
//
angular.module('MUHCApp').controller('logOutController',['Auth','UserAuthorizationInfo','UserDataMutable', '$state','$q', function(Auth, UserAuthorizationInfo,UserDataMutable,$state,$q){
		console.log(Auth);
